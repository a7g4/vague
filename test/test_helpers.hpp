...
void TEST_MATRIX_NEARLY_EQUAL(const M1& m1, const M2& m2, const typename M1::Scalar& epsilon, const Catch::ResultDisposition::Flags& result_disposition)
{
...
template <typename M1, typename M2>
void CHECK_MATRIX_NEARLY_EQUAL(const M1& m1, const M2& m2, const typename M1::Scalar& epsilon = std::numeric_limits<typename M1::Scalar>::epsilon())
{
